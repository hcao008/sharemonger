...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { email: @visitor.email, first_name: @visitor.first_name, last_name: @visitor.last_name, message: @visitor.message, phone: @visitor.phone } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { email: @visitor.email, first_name: @visitor.first_name, last_name: @visitor.last_name, message: @visitor.message, phone: @visitor.phone } }
